...
export const Home = () => {
  ...
  return (
    <div className="min-h-screen pt-[72px] pb-12 flex items-center justify-center relative">
      {/* Content - transparent, showing global background through */}
      <div className="max-w-[1200px] w-full px-8 relative flex flex-col items-center">
        <div className="mb-6 w-full flex justify-center">
          <span className="text-4xl md:text-5xl font-extrabold text-black tracking-wide animate-fadeInUp">Hi, I'm</span>
        </div>
        
        {/* ProfileCard */}
        <div 
          className="mb-12 w-full max-w-[1100px] mx-auto"
        ...
        {/* CTAs */}
        <div 
          className="flex justify-center items-center w-full max-w-[1100px] mx-auto"
